...
export const allBlogs = [automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, jsFrameworksComparison__indexMdx, masteringCssGridLayout__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, nextBlogTailwindcssContentlayerTypscript__indexMdx, nextBlogTailwindcssContentlayerTypscriptEng__indexMdx, progressiveWebAppsPwa__indexMdx, restfulApisBuildingBlocks__indexMdx, webAccessibilityBestPractices__indexMdx, webAccessibilityInclusiveDesign__indexMdx, webDevelopmentToolsProductivity__indexMdx, whatsIsDocker__indexMdx, wordSearchBackendJava__indexMdx, wordSearchNodejs__indexMdx]
