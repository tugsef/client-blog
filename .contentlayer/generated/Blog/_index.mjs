...
export const allBlogs = [automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, masteringCssGridLayout__indexMdx, jsFrameworksComparison__indexMdx, restfulApisBuildingBlocks__indexMdx, progressiveWebAppsPwa__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, webAccessibilityBestPractices__indexMdx, webAccessibilityInclusiveDesign__indexMdx, webDevelopmentToolsProductivity__indexMdx, whatsIsDocker__indexMdx, wordSearchBackendJava__indexMdx, wordSearchNodejs__indexMdx]
