...
export const allBlogs = [automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, jsFrameworksComparison__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, masteringCssGridLayout__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, progressiveWebAppsPwa__indexMdx, webAccessibilityBestPractices__indexMdx, webAccessibilityInclusiveDesign__indexMdx, restfulApisBuildingBlocks__indexMdx, webDevelopmentToolsProductivity__indexMdx, whatsIsDocker__indexMdx, wordSearchBackendJava__indexMdx, wordSearchNodejs__indexMdx]
