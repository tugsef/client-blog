...
## Kavramlar
- **import:** Çalışılan dosya içerisine başka bir modülün dahil edileceğini belirtir. Dahil edilecek modülün içe aktarılacak **ismi** yazılır ve **from** kelimesinden sonra dosyanın **path** yazılır. İhtiyaçlarla birlikte ***import** ve dosyanın **path** de verilerek kullanılabilir.
